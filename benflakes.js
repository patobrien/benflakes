/**
 * jQuery Ben-based snow effects.
 *
 * This is a slight modified version of “jQuery Snow” (http://jqsnow.sourceforge.net/)
 * In honor of the almighty Ben Clark.
 *
 * Sheena Donnelly (2013)
 */
...
function __ShowSnow(settings)
{
    ...
    var snowsrcsize = snowsrc.length;
    ...
    for (i = 0; i < no; ++i) 
    {
        ...
        flake.append("<img src='" + snowsrc[Math.floor(Math.random()*snowsrcsize)] + "'>");
        flake.appendTo("body");
